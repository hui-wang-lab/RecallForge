...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("metadata", postgresql.JSONB(), server_default="'{}'::jsonb", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("doc_type", sa.Text(), nullable=False),
        sa.Column("chunk_type", sa.Text(), server_default="'child'", nullable=False),
        ...
        sa.Column("embedding_metadata", postgresql.JSONB(), server_default="'{}'::jsonb", nullable=False),
        sa.Column("metadata", postgresql.JSONB(), server_default="'{}'::jsonb", nullable=False),
        sa.Column("created_at", postgresql.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=False),
        sa.Column("updated_at", postgresql.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=False),
        sa.Column("deleted_at", postgresql.TIMESTAMP(timezone=True), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("warnings", postgresql.JSONB(), server_default="'[]'::jsonb", nullable=False),
        sa.Column("parse_report", postgresql.JSONB(), server_default="'{}'::jsonb", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("filters", postgresql.JSONB(), server_default="'{}'::jsonb", nullable=False),
        sa.Column("client_filters", postgresql.JSONB(), server_default="'{}'::jsonb", nullable=False),
        ...
        sa.Column("hit_summary", postgresql.JSONB(), server_default="'[]'::jsonb", nullable=False),
        sa.Column("selected_references", postgresql.JSONB(), server_default="'[]'::jsonb", nullable=False),
        sa.Column("answer", sa.Text(), nullable=True),
        sa.Column("refusal_reason", sa.Text(), nullable=True),
        sa.Column("latencies_ms", postgresql.JSONB(), server_default="'{}'::jsonb", nullable=False),
        sa.Column("metadata", postgresql.JSONB(), server_default="'{}'::jsonb", nullable=False),
        sa.Column("status", sa.Text(), nullable=False),
        sa.Column("error_message", sa.Text(), nullable=True),
        sa.Column("created_at", postgresql.TIMESTAMP(timezone=True), server_default=sa.text("now()"), nullable=False),
